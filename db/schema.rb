...
ActiveRecord::Schema.define(version: 2021_09_05_015444) do
  ...
  create_table "shipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "purchase_info_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_info_id"], name: "index_shipping_addresses_on_purchase_info_id"
  end
  ...
  add_foreign_key "shipping_addresses", "purchase_infos"
end
